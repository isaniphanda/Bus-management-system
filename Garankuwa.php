...
<div class="dropdown center">
	  ...
	  <button onclick="myFunction()" class="dropbtn btn-rounded"><h2 class="page-heading">Garankuwa Bus Schedule</h2></button>
...
<section class="container">
	...
	<div class="bus-schedule">
		<table class="schedule-tb">
			<tr>
				<th>07:00am</th>
				<th><a href="" onclick="popupConfirm()">Garankuwa to Sosha N</a></th>
				<th>35</th>
			</tr>
			<tr>
				<th>07:00am</th>
				<th><a href="" onclick="popupConfirm()">Garankuwa to Sosha S</a></th>
				<th>40</th>
			</tr>
			<tr>
				<th>07:00am</th>
				<th><a href="" onclick="popupConfirm()">Garankuwa to Main</a></th>
				<th>15</th>
			</tr>
			<tr>
				<th>07:00am</th>
				<th><a href="" onclick="popupConfirm()">Garankuwa to Arcadia</a></th>
				<th>60</th>
			</tr>
		</table>
	</div>
